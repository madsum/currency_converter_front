export default {
    app_name: 'Valuuttamuunnin',
    local_placeholder: 'paikallinen valuutta', 
    exchange_placeholder: 'vaihtovaluutta',
    amount_in_digit: 'määrä numerolinen',
    amount_button: 'Näytä vaihdettu määrä',
